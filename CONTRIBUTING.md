# Contributing to LlamaList

Thank you for your interest in contributing to LlamaList! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaList:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamalist.git
   cd llamalist
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamalist.git
   ```
...
By contributing to LlamaList, you agree that your contributions will be licensed under the project's MIT License.
